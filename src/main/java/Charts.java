...
public class Charts {
    ...
    public Charts() {
        plot = new CombinedDomainXYPlot(new NumberAxis("Tmms"));

        chart = new JFreeChart("LNPDIS", plot);
        chart.setBorderPaint(Color.black);
        chart.setBorderVisible(true);
        chart.setBackgroundPaint(Color.white);

        frame = new JFrame("LNPDIS");
    ...
    public static void addDiscretData(int chart, boolean data){
